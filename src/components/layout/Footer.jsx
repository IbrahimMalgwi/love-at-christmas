                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/items" className="text-gray-300 hover:text-white">Items Needed</Link></li>
                            <li><Link to="/donate" className="text-gray-300 hover:text-white">Make a Donation</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300">
                            ...
                            <li>Phone: +234 810 465 7320</li>
                            <li>Address: 32A Commercial Avenue, Sabo Yaba, Lagos, Nigeria</li>
                        </ul>
                    </div>
                </div>
