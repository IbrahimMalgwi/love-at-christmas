...
const ItemsManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const itemData = {
                ...
                unit_price_naira: parseFloat(formData.unit_price_naira)
            };
    ...
    const handleEdit = (item) => {
        ...
        setFormData({
            ...
            unit_price_naira: item.unit_price_naira.toString()
        });
        setShowForm(true);
    };
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                step="0.01"
                                value={formData.unit_price_naira}
                                onChange={(e) => setFormData({ ...formData, unit_price_naira: e.target.value })}
                                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500"
                                required
                                min="0"
                            />
                ...
                <div className="overflow-x-auto">
                    ...
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800 capitalize">
                      {item.category}
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ₦{item.unit_price_naira?.toLocaleString()}
                                </td>
